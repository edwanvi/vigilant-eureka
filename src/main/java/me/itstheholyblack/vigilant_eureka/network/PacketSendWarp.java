...
public class PacketSendWarp implements IMessage {
    ...
    public PacketSendWarp() {
        // Calculate the position of the block we are looking at
        RayTraceResult result = Minecraft.getMinecraft().objectMouseOver;
        blockPos = result.getBlockPos();
    }

    public static class Handler implements IMessageHandler<PacketSendWarp, IMessage> {
        @Override
        public IMessage onMessage(PacketSendWarp message, MessageContext ctx) {
        ...
        private void handle(PacketSendWarp message, MessageContext ctx) {
